...
const Welcome = ({ currentUnitCalculation, username, setShowSettings }: WelcomeProps) =>
  <div className="app-welcome">
    <p>{getWelcomeMessage()} <b>{username}</b></p>
    <span>
      Unit Calculation: 10g = {currentUnitCalculation} unit
      <svg onClick={() => setShowSettings(true)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
